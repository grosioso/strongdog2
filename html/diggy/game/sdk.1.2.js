        ...
        (function (l) {
            function h(a) {
                for (var g = a.length, e = 0; e < g; ++e) {
                    var c = a[e];
                    if (void 0 == c) a[e] = String(c); else if ("object" === typeof c) try {
            ...
            var h = function () {
                ...
                a.eh = function () {
                    Array.prototype.filter || (Array.prototype.filter = function (a, e) {
                        ...
                        var c = this.length >>> 0, m = Array(c), g = 0, f = -1;
                        if (void 0 === e) for (; ++f !== c;) f in this && a(this[f], f, this) && (m[g++] = this[f]); else for (; ++f !== c;) f in this && a.call(e, this[f], f, this) && (m[g++] = this[f]);
                        m.length = g;
                        return m
                    })
                };
    ...
    (function (p) {
        (function (l) {
            ...
            var e = function () {
                ...
                a.s = function (c, e) {
                    if (h.c) h.c.on(c, e); else a.yc.s(c, e)
                };
                a.h = function (c) {
...
(function (a) {
    (function (p) {
        (function (l) {
            var h = a.a.m.aa, f = a.a.m.W, g = function () {
                function a() {
                }
...
(function (a) {
    (function (p) {
        (function (l) {
            var h = a.a.g.ab, f = a.a.m.W, g = a.a.m.aa, e = a.a.D.vd, c = function () {
                function a() {
                }
            ...
            var t = function () {
                ...
                a.Je = function (a) {
                    void 0 === a && (a = c.Fb);
                    if (h.c) h.c.ui.openElement(a); else switch (a) {
                        case c.Ed:
                            null != p.$ && p.$.Oe()
                    }
                };
    ...
    (function (p) {
        (function (l) {
            var h = a.a.m.aa, f = a.a.m.W, g = function () {
                ...
                a.Tj = function () {
                    if (!a.H) return {width: -1, height: -1};
                    var c = a.H.clientWidth, e = a.H.clientHeight;
                    c *= a.Hb();
                    e *= a.Hb();
                    return {width: c, height: e}
                };
                a.bk = function () {
                    var c = window.screen.width, e = window.screen.height, g = window.outerWidth,
                        f = window.outerHeight, d = c / e, k = g / f;
                ...
                a.lb = function (c) {
                    ...
                    for (var e, g = a.M.children, f = g.length, d = 0; d < f; ++d) if ((e = a.va(g[d])) && a.T(e) === c) return e;
                    return null
                };
                a.Kj = function (c) {
                    if (void 0 == c) return null;
        ...
        (function (l) {
            var h = a.a.m.W, f = function (a) {
                ...
                e.prototype.load = function (a) {
                    this.pe = a;
                    var c = a.headers || [], e = c.some(function (a) {
                        return !!a.name && "content-type" == a.name
                    });
                    a.contentType && !e && c.push(new l.bg("Content-Type", a.contentType));
                    e = a.url;
                    if (a.data) if ("string" === typeof a.data) var g = a.data; else if (a.data instanceof ArrayBuffer) g = new DataView(a.data); else if (a.data instanceof Uint8Array) g = new DataView(a.data.buffer);
                    else try {
                ...
                e.prototype.ng = function (a) {
                    var c = "arraybuffer", e = this.pe.contentType;
                ...
                e.prototype.sg = function () {
                    var a = this.P.readyState, e = this.P.status;
...
(function (a) {
    (function (p) {
        (function (l) {
            ...
            var f = a.a.m.aa, g = a.a.m.W, e = a.a.g.Mb, c = a.a.g.Ac, m = a.a.g.Bc, n = a.a.g.Lb, t = 0;
            l.Storage = function () {
                function a() {
                }
                ...
                a.Ti = function () {
                    ...
                    if ("string" !==
                        typeof a) a = null; else if (0 === a.indexOf("file:")) a = "localhost"; else {
                        var d = a = h(a);
                        if (null != a) {
                    ...
                    return new Promise(function (d, q) {
                        a.Za ? a.K ? p.$.Yg().then(function (q) {
                                if (-1 == document.location.search.indexOf("user_id") || "object" === typeof window.cordova || p.$.name != p.jd.gj && p.$.name !=
                                    p.jd.Ue && p.$.name != p.jd.xi) a.qa(q), a.ya(), d(); else {
                                    var k = new c;
                                    k.s(g.COMPLETE, function () {
                                        try {
                                            var c = new Uint8Array(k.data), u = e.Te(c), g = JSON.parse(u);
                                    ...
                                    var u = new m(""), f = a.De(document.location.search).user_id;
                                    u.data = "user_id=" + f;
                                    u.method = n.Jf;
            ...
            var d = function () {
                    ...
                    this.V[a] !== d && (this.V[a] = d, this.Ra || this.Pa(function (q) {
                        c.Oc ? q.transaction([c.G], "readwrite").objectStore(c.G).clear(a).onsuccess = function () {
                            Object.keys(c.V).forEach(function (a) {
                                q.transaction([c.G], "readwrite").objectStore(c.G).put({key: a, value: c.V[a]})
                            })
                        } : q.transaction([c.G],
                            "readwrite").objectStore(c.G).put({key: a, value: d})
                    }))
                };
                a.prototype.Pa = function (a, d) {
                    ...
                    try {
                        ...
                        k.onupgradeneeded = function (k) {
                            q = !0;
                            k.currentTarget.result.createObjectStore(c.G, {keyPath: "key"});
                            c.Pa(a, d)
                        }
                    } catch (K) {
                        d && d()
                ...
                var a = navigator.appVersion, d = navigator.userAgent, c = navigator.appName,
                    k = "" + parseFloat(navigator.appVersion), e, g, f;
                -1 != (g = d.indexOf("Opera")) ? (c = "Opera", k = d.substring(g + 6), -1 != (g = d.indexOf("Version")) && (k = d.substring(g + 8))) : -1 != (g = d.indexOf(" OPR")) ? (c = "Opera", k = d.substring(g + 5)) : -1 != (g = d.indexOf("MSIE")) ? (c = "Microsoft Internet Explorer", k = d.substring(g + 5)) : -1 != (g = d.indexOf("Edge")) ? (c = "Microsoft Edge", k = d.substring(g + 5)) : -1 != (g = d.indexOf("Chrome")) ? (c = "Chrome", k = d.substring(g +
                    7)) : -1 != (g = d.indexOf("Safari")) ? (c = "Safari", k = d.substring(g + 7), -1 != (g = d.indexOf("Version")) && (k = d.substring(g + 8))) : -1 != (g = d.indexOf("Firefox")) ? (c = "Firefox", k = d.substring(g + 8)) : -1 != d.indexOf("Trident/") ? (c = "Microsoft Internet Explorer", k = d.substring(d.indexOf("rv:") + 3)) : (e = d.lastIndexOf(" ") + 1) < (g = d.lastIndexOf("/")) && (c = d.substring(e, g), k = d.substring(g + 1), c.toLowerCase() == c.toUpperCase() && (c = navigator.appName));
                -1 != (f = k.indexOf(";")) && (k = k.substring(0, f));
                -1 != (f = k.indexOf(" ")) && (k = k.substring(0,
                    f));
                -1 != (f = k.indexOf(")")) && (k = k.substring(0, f));
                ...
                f = "-";
                var m = [{v: "Windows 10", r: /(Windows 10.0|Windows NT 10.0)/}, {
                    v: "Windows 8.1",
                    r: /(Windows 8.1|Windows NT 6.3)/
                }, {v: "Windows 8", r: /(Windows 8|Windows NT 6.2)/}, {v: "Windows 7", r: /(Windows 7|Windows NT 6.1)/},
                    {v: "Windows Vista", r: /Windows NT 6.0/}, {
                        v: "Windows Server 2003",
                        r: /Windows NT 5.2/
                    }, {v: "Windows XP", r: /(Windows NT 5.1|Windows XP)/}, {
                        v: "Windows 2000",
                        r: /(Windows NT 5.0|Windows 2000)/
                    }, {v: "Windows ME", r: /(Win 9x 4.90|Windows ME)/}, {
                        v: "Windows 98",
                        r: /(Windows 98|Win98)/
                    }, {v: "Windows 95", r: /(Windows 95|Win95|Windows_95)/}, {
                        v: "Windows NT 4.0",
                        r: /(Windows NT 4.0|WinNT4.0|WinNT|Windows NT)/
                    }, {v: "Windows CE", r: /Windows CE/}, {v: "Windows 3.11", r: /Win16/}, {
                        v: "Android",
                        r: /Android/
                    }, {v: "Open BSD", r: /OpenBSD/},
                    {v: "Sun OS", r: /SunOS/}, {v: "Linux", r: /(Linux|X11)/}, {
                        v: "iOS",
                        r: /(iPhone|iPad|iPod)/
                    }, {v: "Mac OS X", r: /Mac OS X/}, {
                        v: "Mac OS",
                        r: /(MacPPC|MacIntel|Mac_PowerPC|Macintosh)/
                    }, {v: "QNX", r: /QNX/}, {v: "UNIX", r: /UNIX/}, {v: "BeOS", r: /BeOS/}, {
                        v: "OS/2",
                        r: /OS\/2/
                    }, {
                        v: "Search Bot",
...
(function (a) {
    (function (p) {
        (function (l) {
            var h = a.a.g.Storage, f = a.a.display.Na, g = a.a.g.Ha, e = a.a.m.aa, c = a.a.m.W, m = a.a.D.Yd;
            l.fi = function () {
                function a() {
                }
                ...
                a.La = function () {
                    if (!a.i) {
                        ...
                        if (a.b) {
                            ...
                            for (d = 0; d < c; d++) if ("path" === a.b.childNodes[d].localName && "IceLoaderSVG" == a.b.childNodes[d].id) {
                ...
                a.lb = function () {
                    ...
                    e.s(c.ae,
                        function (c) {
                            ...
                            if (a.b) {
                                c = a.b.childNodes.length;
                                for (var d = 0; d < c; d++) if ("path" === a.b.childNodes[d].localName && "IceLoaderSVG" == a.b.childNodes[d].id) {
                                    if ("default" == a.u || "" == a.u || null == a.u) switch (a.K) {
                                        case m.ha:
                                            a.b.childNodes[d].setAttribute("fill", "#ffffff");
                                            break;
...
(function (a) {
    (function (p) {
        (function (l) {
            var h = a.a.g.Ha, f = a.a.display.Na, g = function () {
                function a() {
                ...
                a.prototype.Rc = function () {
                    ...
                    if (this.Ca = document.getElementById("btn_panel")) if (this.Nb = h.Cb("ui/storeButton.svg"),
                ...
                a.prototype.Va = function () {
                    ...
                    if (this.O) {
                        ...
                        if (a) {
                            var e = window.innerHeight, g = window.innerWidth;
                ...
                a.prototype.gb = function () {
                    this.o += this.S;
                    var a = this.yb(this.N), e = document.getElementById("btn_panel");
...
(function (a) {
    (function (p) {
        (function (l) {
            (function (h) {
                (function (f) {
                    var g = a.a.g.Ac, e = a.a.g.Bc, c = a.a.g.Lb, h = a.a.m.W, l = a.a.g.Mb, p = a.a.display.Na,
                        d = function () {
                            function a() {
                            ...
                            a.prototype.Rc = function () {
                                var d = this;
                                if (a.Ph()) this.O = !1; else {
                                    var k = new g;
                                    k.s(h.COMPLETE, function () {
                                        if (k.data && "" != k.data) {
                                            var a = window.JSON.parse(k.data);
                                            d.Pb = !0;
                                            window.GD_OPTIONS = {gameId: a.api_key, onEvent: d.og.bind(d)};
                                            var c = document.getElementsByTagName("script")[0];
                                            document.getElementById("gamedistribution-jssdk") ||
                                            (a = document.createElement("script"), a.id = "gamedistribution-jssdk", a.src = "http://html5.api.gamedistribution.com/main.min.js", c.parentNode.insertBefore(a, c))
                                        }
                                        l.Tc(k)
                                    });
                            ...
                            a.prototype.og = function (a) {
                                switch (a.name) {
                                    case "SDK_READY":
                                        this.Pb = !1, this.O = this.me = !0, this.Zb("api_inited");
                                        this.Zb("gds_resume");
                                        break;
                                    case "SDK_GAME_START":
...
(function (a) {
    (function (p) {
        (function (l) {
            (function (h) {
                var f = a.a.g.Id, g = a.a.g.Storage, e = a.a.j.vb.ze.pf, c = a.a.m.Eb, m = a.a.m.aa, n = function () {
                    function a() {
                        this.name = l.tc.xd;
                        this.eb = !1
                    }
...
(function (a) {
    (function (p) {
        (function (l) {
            var h = a.a.g.Storage, f = a.a.m.W, g = a.a.m.aa, e = a.a.m.Eb, c = a.a.D.Af, m = function () {
                function a() {
                }
            ...
            var d = function () {
                ...
                a.prototype.fe = function (c) {
                    ...
                    if (d.hasOwnProperty("blockListGameUrl")) h.Fh(),
                        h.Ch(d.blockListGameUrl), h.Bh(d.contactIce), g.h(f.Sd); else {
                        this.fb = [];
                        if (e = d.providers) for (var q = e.length, k = 0; k < q; k++) {
                            var m = e[k];
                ...
                a.prototype.Nf = function (a) {
                    var c, d, e = [], q = this.ca.length;
                    for (c = 0; c < q; c++) {
                        var g = this.ca[c].l, k = g.length;
                ...
                a.prototype.Wh = function () {
                    ...
                    for (a = 0; a < d; a++) {
                        var e = this.ca[a], g = e.l.length;
                        for (c = 0; c < g; c++) if (0 < e.l[c].Xb) {
                ...
                a.prototype.qh = function (a, c) {
                    ...
                    for (d = 0; d < g; d++) if (0 < a.l[d].R && -1 == this.Y.indexOf(a.l[d])) {
                        var k = !1, f = a.l[d].R,
                            q = this.Y.length;
                        for (e = 0; e < q; e++) if (this.Y[e].R < f) {
                ...
                a.prototype.Uh = function (a) {
                    var c = 0, d = !1, e, g = a.l.length;
                    if (this.Fc) for (e = 0; e < g; e++) "Absolutist" != a.l[e].name && (a.l[e].Xb = 0);
                    for (e = 0; e < g; e++) a.l[e].R = a.l[e].Xb, 0 < a.l[e].R && (c += a.l[e].R, d = !0);
                    if (d) {
                        d = 100 / c;
                        var k = g = c = 0, f = a.l.length;
                ...
                a.prototype.zh = function (a) {
                    var c =
                        100 * Math.random(), d = 0, e, g = a.l.length;
                    for (e = 0; e < g; e++) {
                ...
                a.prototype.ia = function (a, c) {
                    void 0 === c && (c = null);
                    this.Vh();
                    if (a = this.Xc(a)) if (a.state != l.Xa.zd) null != c && c(n.pd); else {
                        this.Uh(a);
                        var d = this.zh(a);
                        if (d) {
                ...
                a.prototype.xh = function (a) {
                    var c = "ad_" + a + "_lastShowTime", d = "ad_" + a + "_lastShowDay",
                        e = "ad_" + a + "_showNumsPerDay", g = (new Date).getTime();
                ...
                a.prototype.Ke = function (a) {
                    var c = "ad_" + a + "_showNumsPerDay", d = (new Date).getTime();
...
(function (a) {
    (function (p) {
        (function (l) {
            ...
            var f = a.a.m.aa, g = a.a.m.Eb, e = a.a.m.W, c = a.a.g.Storage, m = a.a.j.sc, n = a.a.g.ab, t = a.a.g.$f,
                d = a.a.display.Na, k = function () {
                    function a() {
                    }
...
(function (a) {
    (function (p) {
        (function (l) {
            var h = a.a.g.Storage, f = a.a.g.ab, g = function () {
                function a() {
                }
                    ...
                    this.V[a] !== c && (this.V[a] = c, this.Ra || this.Pa(function (f) {
                        e.Oc ? f.transaction([e.G], "readwrite").objectStore(e.G).clear(a).onsuccess = function () {
                            Object.keys(e.V).forEach(function (a) {
                                f.transaction([e.G], "readwrite").objectStore(e.G).put({key: a, value: e.V[a]})
                            })
                ...
                a.prototype.Pa = function (a, c) {
                    ...
                    try {
                        ...
                        g.onupgradeneeded = function (d) {
                            f = !0;
                            d.currentTarget.result.createObjectStore(e.G, {keyPath: "key"});
                            e.Pa(a, c)
                        }
                    } catch (d) {
                        c && c()
...
(function (a) {
    (function (p) {
        (function (l) {
            var h = a.a.g.Ha, f = a.a.display.Na, g = a.a.m.aa, e = a.a.m.W, c = a.a.g.Storage, m = a.a.g.ab,
                p = a.a.g.Zf, t = function () {
                    function d() {
                    }

                    d.af = function () {
                        var a = document.getElementById("button"), d = c.Ng(), e = document.getElementById("contact_link"),
                            f = document.getElementById("play"), g = c.Og(), h = document.getElementById("play_img"),
                            l = document.getElementById("contact"), m = 642 / 4500, p = .266625, n = window.innerHeight * m,
                            r = window.innerWidth * p, t = window.innerHeight / .5625 < window.innerWidth ? "hor" : "vert";
                        e.innerHTML = d;
                    ...
                    d.Cj = function () {
                        ...
                        window.requestAnimationFrame(function () {
                            ...
                            p.initializeAsync().then(function () {
                            }).catch(function () {
                            })
                        });
                        g.s(e.bb, function () {
                        ...
                        g.s(e.Kb, function (a) {
                            var c = a[0];
                            a = a[1];
                            h5branding.SplashLoader.getInstance().setLoadProgress("" + Math.floor(c * 100));
                        ...
                        g.s(e.$a, function (a) {
                            ...
                            if (void 0 != c && void 0 != a) {
                                var e = c / a * 100 | 0, f = document.getElementById("progressText");
                                if (f) {
                                    var g = d.Vc(e, 1, 99, 100) | 0;
                                    95 <= e && (g = 100);
                                    f.textContent = g + "";
                                    c = c / a * d.wh + d.ye;
                                    (a = document.getElementById("bar")) && !isNaN(c) && (e = a.getAttribute("r"),
                                    e = 2 * Math.PI * e, 0 > c && (c = 0), 100 < c && (c = 100), a.setAttribute("stroke-dashoffset", (100 - c) / 100 * e))
                                }
                            }
                        });
                        g.s(e.Hd, function () {
                        ...
                        g.s(e.COMPLETE, function () {
                            "hidden" != d.Ya.style.visibility && (d.Ya.style.visibility = "hidden", d.u.style.visibility = "visible")
                        });
                        return d.jh()
                    }();
                    d.S = 10;
...
(function (a) {
            ...
            function k(e) {
                if ("object" === typeof window.cordova || "Microsoft Internet Explorer" == A.I()) {
                    ...
                    f.onload = function () {
                        var a =
                            c.indexOf(e);
                        -1 < a && (c.splice(a, 1), 0 === c.length && g(), R.Kg(f))
                    };
                    f.onerror = h;
                    ...
                    l.s(r.COMPLETE, function () {
                        ...
                        R.Tc(l);
                        var d = c.indexOf(e);
                        -1 < d && (c.splice(d, 1), 0 === c.length && (y.h(r.COMPLETE), g()))
                    });
                    l.s(r.Db, function () {
    ...
    function g(c, d, e) {
        Q ? e() : (S = a.a.Uj = new K, x.j.initializeAsync =
            ...
            D().then(function () {
                ...
                var a = window.IceStone.evalArray.length, c;
    ...
    console.error('start load SplashLoader');
    h5branding.SplashLoader.getInstance({
        gameId: '7a0b704e90f1414986920c135f25da28',
        gameName: 'Diggy',
        gameTitle: 'Diggy',
        libs: [],
        version: '1.0'
        ...
        a.initializeAsync = e;
        // console.error('SplashLoader loaded');
    }).catch((e) => {
        // console.error('cannot load splashloader');
    });

    var x = a.a.j.sc, U = a.a.Da.df, K = a.a.Ie.Ef, A = a.a.g.Storage, y = a.a.m.aa, r = a.a.m.W, D = a.a.game.yg,
        w = a.a.game.wg, M = a.a.g.Ac, B = a.a.g.Bc, z = a.a.g.Lb, F = a.a.display.Na, C = a.a.g.Id, X = a.a.g.Ha,
        V = a.a.D.zf, v = a.a.g.ab, G = a.a.D.vd, R = a.a.g.Mb;
    a.Event = a.a.m.Eb;
    a.Event = a.Event;
    a.qf = a.a.game.Yf;
    a.GameState = a.qf;
    ...
    a.D = a.a.D.Zd;
    a.ui = a.D;
    var Q, S, W = X.json("config.json"), N = !1, E = !1;
    a.isPrerollShowed = !1;
    var O = null, P = null;
    a.evalArray;
...
var I = window.__IceStone.cloneObj || window.IceStone || (window.IceStone = {}), T = I.a || (I.a = {}), Y = I.a.j.tc;
T.$ = I.a.j.sc.j;
T.jd = Y;
(function (a) {
    (function (p) {
        (function (l) {
            var h = a.a.g.Storage, f = a.a.g.Ha, g = a.a.display.Na, e = a.a.m.W, c = a.a.m.aa, m = function () {
                function a() {
                ...
                a.prototype.Rc = function () {
                    ...
                    if (this.Ca = document.getElementById("s3eFBIGLeaderboardInviteFriends")) {
                        ...
                        if (this.F = document.getElementById("cross-promo")) if (this.F.style.display = "none", this.F.style.marginTop = "4%", this.F.parentElement) for (this.F.parentElement.style.height = "78%", k = k = 0; k < this.F.parentElement.children.length; k++) if (l = this.F.parentElement.children[k], "cross-promo" != l.id) {
                            l.style.height = "85%";
                            break
                        }
                ...
                a.prototype.Lh =
                    function () {
                        ...
                        if (this.F && 4 <= this.Ic.length) {
                            ...
                            for (h = 0; 4 > h; h++) {
                                var l = parseInt(Math.random() * g.length + "", 10), m = g[l];
                                f(m.image, m.link);
                                g.splice(l, 1)
                            }
                        } else if (this.F && (this.F.style.marginTop = "", this.F.parentElement)) for (this.F.parentElement.style.height = "85%", f = f = 0; f < this.F.parentElement.children.length; f++) if (g = this.F.parentElement.children[f],
                        "cross-promo" != g.id) {
                            g.style.height = "100%";
                            break
                        }
